		...
		<div class="row">
			<div class="col-xl-12">
				...
				<ul class="navbar-nav ml-auto">
					...
					<a  class="nav-link tm-nav-link tm-text-white loginBtn" href="login">Login</a>
					</s:authorize>
					<s:authorize ifAnyGranted="ROLE_USER,ROLE_ADMIN"><!-- 둘 중 아무나 인증을 받았으면 로그아웃 버튼 활성화 시키다.  -->
					    <s:authentication property="name" var="loginUser"/>
						<a class="nav-link tm-nav-link tm-text-white loginBtn" href="${pageContext.request.contextPath }/j_spring_security_logout">Logout</a><!-- 인증받은 계쩡 명 가져오기 -->
					</s:authorize>
					</li>
